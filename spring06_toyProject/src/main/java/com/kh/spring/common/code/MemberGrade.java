...
public enum MemberGrade {
	...
	//회원등급코드 ME00은 코드info가 '일반'이고 연장가능횟수가 1회
	//enum은 내부적으로 class이다.
	//ME00("일반",1) -> 실제로 돌 때는 public static final MemberGrade Me00 = new MEmberGrade("일반",1);
	//인스턴스화
	ME00("일반","user",1),
	ME01("성실","user",2),
	ME02("우수","user",3),
	...
	AD01("member","admin",9999), //회원관리자 등급코드
	...
	private MemberGrade(String desc,String role,int extendableCnt) {
		this.DESC = desc; //생성자를 통한 초기화를 진행
		this.ROLE = role;
